...
set_property IOSTANDARD LVCMOS18 [get_ports {flash_program_mode}]

##IO_L24P_T3_34
set_property PACKAGE_PIN P15 [get_ports {normal_mode}]
set_property IOSTANDARD LVCMOS18 [get_ports {normal_mode}]

#IO_L4N_T0_34
set_property PACKAGE_PIN W13 [get_ports {program_loaded}]
set_property IOSTANDARD LVCMOS18 [get_ports {program_loaded}]

#IO_L9P_T1_DQS_34
set_property PACKAGE_PIN T16 [get_ports {dbg_en_ext_i }]
set_property IOSTANDARD LVCMOS18 [get_ports {dbg_en_ext_i}]
##################################################################
...
set_property IOSTANDARD LVCMOS18 [get_ports {master_rst_n}]

#IO_L24N_T3_34
#set_property PACKAGE_PIN P16 [get_ports {ta_cci0a}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ta_cci0a}]

##IO_L18P_T2_34
#set_property PACKAGE_PIN V16 [get_ports {ta_ccia0b}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ta_ccia0b}]


############################GPIO_IN PMOD_JD###################
#IO_L18P_T2_34
set_property PACKAGE_PIN T14 [get_ports {p1_din[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {p1_din[0]}]

##IO_L7P_T1_34
set_property PACKAGE_PIN T15 [get_ports {p1_din[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {p1_din[1]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {memory_error}]

#IO_L23N_T3_35
set_property PACKAGE_PIN M15 [get_ports {memory_check_done}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory_check_done}]

#IO_0_35
set_property PACKAGE_PIN G14 [get_ports {start_load}]
set_property IOSTANDARD LVCMOS18 [get_ports {start_load}]

##IO_L3N_T0_DQS_AD1N_35
#set_property PACKAGE_PIN D18 [get_ports {p1_din[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {p1_din[0]}]
##############################################################
##I2S Audio Codec
##IO_L12N_T1_MRCC_35
#set_property PACKAGE_PIN K18 [get_ports ac_bclk]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_bclk]
...
#set_property IOSTANDARD LVCMOS18 [get_ports ac_muten]

##IO_L8P_T1_AD10P_35
#set_property PACKAGE_PIN M17 [get_ports ac_pbdat]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_pbdat]

##IO_L11N_T1_SRCC_35
#set_property PACKAGE_PIN L17 [get_ports ac_pblrc]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_pblrc]

##IO_L12P_T1_MRCC_35
#set_property PACKAGE_PIN K17 [get_ports ac_recdat]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_recdat]

##IO_L8N_T1_AD10N_35
#set_property PACKAGE_PIN M18 [get_ports ac_reclrc]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_reclrc]

##Audio Codec/external EEPROM IIC bus
##IO_L13P_T2_MRCC_34
#set_property PACKAGE_PIN N18 [get_ports ac_scl]
#set_property IOSTANDARD LVCMOS18 [get_ports ac_scl]
...
#set_property IOSTANDARD LVCMOS18 [get_ports eth_rst_b]
...
#set_property IOSTANDARD LVCMOS18 [get_ports hdmi_cec]

##IO_L5P_T0_AD9P_35
#set_property PACKAGE_PIN E18 [get_ports hdmi_hpd]
#set_property IOSTANDARD LVCMOS18 [get_ports hdmi_hpd]

##IO_L6N_T0_VREF_35
#set_property PACKAGE_PIN F17 [get_ports hdmi_out_en]
#set_property IOSTANDARD LVCMOS18 [get_ports hdmi_out_en]
...
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_n[0]}]

##IO_L21P_T3_DQS_AD14P_35
#set_property PACKAGE_PIN N15 [get_ports {ja_p[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_p[0]}]

##IO_L22N_T3_AD7N_35
#set_property PACKAGE_PIN L15 [get_ports {ja_n[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_n[1]}]

##IO_L22P_T3_AD7P_35
#set_property PACKAGE_PIN L14 [get_ports {ja_p[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_p[1]}]

##IO_L24N_T3_AD15N_35
#set_property PACKAGE_PIN J16 [get_ports {ja_n[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_n[2]}]

##IO_L24P_T3_AD15P_35
#set_property PACKAGE_PIN K16 [get_ports {ja_p[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_p[2]}]

##IO_L20N_T3_AD6N_35
#set_property PACKAGE_PIN J14 [get_ports {ja_n[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_n[3]}]

##IO_L20P_T3_AD6P_35
#set_property PACKAGE_PIN K14 [get_ports {ja_p[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ja_p[3]}]
...
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_p[0]}]

##IO_L16N_T2_34
#set_property PACKAGE_PIN W20 [get_ports {jb_n[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_n[1]}]

##IO_L16P_T2_34
#set_property PACKAGE_PIN V20 [get_ports {jb_p[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_p[1]}]

##IO_L17N_T2_34
#set_property PACKAGE_PIN Y19 [get_ports {jb_n[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_n[2]}]

##IO_L17P_T2_34
#set_property PACKAGE_PIN Y18 [get_ports {jb_p[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_p[2]}]

##IO_L22N_T3_34
#set_property PACKAGE_PIN W19 [get_ports {jb_n[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_n[3]}]

##IO_L22P_T3_34
#set_property PACKAGE_PIN W18 [get_ports {jb_p[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jb_p[3]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {dbg_uart_rxd_in}]

#IO_L10P_T1_34
set_property PACKAGE_PIN V15 [get_ports {dbg_uart_txd}]
set_property IOSTANDARD LVCMOS18 [get_ports {dbg_uart_txd}]
...
##IO_L8N_T1_34
#set_property PACKAGE_PIN Y14 [get_ports {ta_out0}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ta_out0}]

##IO_L8P_T1_34
#set_property PACKAGE_PIN W14 [get_ports {ta_out0_en}]
#set_property IOSTANDARD LVCMOS18 [get_ports {ta_out0_en}]

##############################GPIO_OUTS#########################
#IO_L2N_T0_34
set_property PACKAGE_PIN U12 [get_ports {p1_dout[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {p1_dout[0]}]

#IO_L2P_T0_34
set_property PACKAGE_PIN T12 [get_ports {p1_dout[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {p1_dout[1]}]

################################################################
##Pmod Header JD
##IO_L5N_T0_34
#set_property PACKAGE_PIN T15 [get_ports {jd_n[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_n[0]}]

##IO_L5P_T0_34
#set_property PACKAGE_PIN T14 [get_ports {jd_p[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_p[0]}]

##IO_L6N_T0_VREF_34
#set_property PACKAGE_PIN R14 [get_ports {jd_n[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_n[1]}]

##IO_L6P_T0_34
#set_property PACKAGE_PIN P14 [get_ports {jd_p[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_p[1]}]

##IO_L11N_T1_SRCC_34
#set_property PACKAGE_PIN U15 [get_ports {jd_n[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_n[2]}]

##IO_L11P_T1_SRCC_34
#set_property PACKAGE_PIN U14 [get_ports {jd_p[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_p[2]}]

##IO_L21N_T3_DQS_34
#set_property PACKAGE_PIN V18 [get_ports {jd_n[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_n[3]}]

##IO_L21P_T3_DQS_34
#set_property PACKAGE_PIN V17 [get_ports {jd_p[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {jd_p[3]}]

##Pmod Header JE
##IO_L4P_T0_34
#set_property PACKAGE_PIN V12 [get_ports {je[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[0]}]

##IO_L18N_T2_34
#set_property PACKAGE_PIN W16 [get_ports {je[1]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[1]}]

##IO_25_35
#set_property PACKAGE_PIN J15 [get_ports {je[2]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[2]}]

##IO_L19P_T3_35
#set_property PACKAGE_PIN H15 [get_ports {je[3]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[3]}]

##IO_L3N_T0_DQS_34
#set_property PACKAGE_PIN V13 [get_ports {je[4]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[4]}]

##IO_L9N_T1_DQS_34
#set_property PACKAGE_PIN U17 [get_ports {je[5]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[5]}]

##IO_L20P_T3_34
#set_property PACKAGE_PIN T17 [get_ports {je[6]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[6]}]

##IO_L7N_T1_34
#set_property PACKAGE_PIN Y17 [get_ports {je[7]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {je[7]}]


##USB-OTG overcurrent detect pin
##IO_L3P_T0_DQS_PUDC_B_34
#set_property PACKAGE_PIN U13 [get_ports otg_oc]
#set_property IOSTANDARD LVCMOS18 [get_ports otg_oc]
